...
@interface SinaWeibo : NSObject <SinaWeiboAuthorizeViewDelegate, SinaWeiboRequestDelegate,SinaWeiboAuthorizeView2Delegate>
{
    NSString *userID;
...
- (UIViewController *)logInWithController;
