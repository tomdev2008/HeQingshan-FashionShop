...
- (void)viewDidLoad{
   ...
   //NSString *strCancel = [main localizedStringForKey:KLanguageCancel value:nil table:kTCWBTable];
    ...
    UIImage *sheepImage = [UIImage imageNamed:@"goback_icon.png"];
    ...
    [sheepButton addTarget:self action:@selector(onButtonCancel) forControlEvents:UIControlEventTouchUpInside];
