...
@optional
- (void)flowView:(WaterflowView *)flowView didSelectRow:(WaterFlowCell *)cell;
...
@interface WaterflowView : UIScrollView<UIScrollViewDelegate>
{
	...
	id <WaterflowViewDelegate> __weak _flowdelegate;
    id <WaterflowViewDatasource> __weak _flowdatasource;
}
